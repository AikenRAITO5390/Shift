	...
	<h2 class="login-header">従業員Login</h2>
	 ...
	 <div class="id">
		...
		<div class="form-group">
            <label>ＩＤ:</label>
            <input type="text" id="WORKER_ID" name="WORKER_ID"  maxlength="10" placeholder="10文字以内の半角英数字でご入力下さい"
     ...
     <div id="emailDiv" class="hidden">
     	...
     	<div class="form-group">
            <label>パスワード:</label>
            <input type="password" id="passwordField" name="WORKER_PASSWORD" maxlength="20" placeholder="20文字以内の半角英数字でご入力下さい" style="ime-mode: disabled" required/></div>
